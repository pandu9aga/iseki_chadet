	...
	<body>
			...
			<div class="container-fluid">
				<div class="row cb-slideshow-text-container ">
					...
					<header class="mb-5"><h1>Chadet</h1></header>
                    ...
                    <form action="#" method="get" class="subscribe-form">
               	    	<div class="row form-section">
							...
							<div class="col-md-7 col-sm-7 col-xs-7">
			                      <input name="text" type="text" class="form-control" id="contact_email" placeholder="NIK..." required/>
				  			</div>
							<div class="col-md-5 col-sm-5 col-xs-5">
                                <a href="{{ route('home') }}">
								    <button type="button" class="tm-btn-subscribe">Login</button>
                                </a>
							</div>
				...
				<div class="footer-link">
					<p>Copyright © <script>document.write(new Date().getFullYear())</script> PT. Iseki Indonesia - Chasis Detector</p>
				</div>
			</div>	
	</body>
